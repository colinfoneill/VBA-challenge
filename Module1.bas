...
Sub Stocks()
    ...
    For Each ws In Worksheets
        ...
        'find the last row and last column in each sheet
        ...
        For Row = 2 To LastRow
                ...
                If ws.Cells(Row, 1).Value <> ws.Cells(Row + 1, 1).Value Then
                    ...
                    'set StockVolume to 0 after the ticker changes
                    StockVolume = 0
                    
                    'reset the open price after the ticker changes
                    OpenPrice = ws.Cells(Row + 1, 3)
                              
                'add incremental ticker stock volume to total ticker stock volume
                Else
    ...
    'loop through each yearly change value in the summary table and format positive green and negative red
        ...
        'loop through each row in the % change column and print the max % and corresponding ticker in the second summary table
        ...
        'print Max % in the second summary table and format as %
        ...
        'print Min % in the second summary table
        'ws.Range("Q3").Value = MinPercentage
        'ws.Range("Q3").NumberFormat = "0.00%"
        
        'find the greatest total volume in the first summary table
        
        
        
        'print greatest total volume in the second summary table
